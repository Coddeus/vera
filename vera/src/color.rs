...
impl Color {
    pub(crate) const WHITISH: Self = Self([0.9, 0.9, 0.9, 1.0]);   // Can be seen on (common) pure white backgrounds
    pub(crate) const BLACKISH: Self = Self([0.1, 0.1, 0.1, 1.0]);  // Can be seen on (common) pure black backgrounds
